...
var canvasWidth = radius * 1 + margin.left + margin.right,
  canvasHeight = radius * 1 + margin.top + margin.bottom;
...
function pieChart() {
  ...
  var json = getData();
  var canvaCenterX = (radius * 1 + margin.left + margin.right) / 1;
  var canvaCenterY = (radius * 1 + margin.top + margin.bottom) / 1;
