...
(function () {
  ...
  // Line Chart
  // --------------------------------------------------------------------
  const lineChartEl = document.querySelector('#lineChart-sale'),
    lineChartConfig = {
      chart: {
        height: 220,
        type: 'line',
  ...
  // line chart assets
  const lineChartE2 = document.querySelector('#lineChart-asset'),
    lineChartassetConfig = {
      chart: {
        height: 220,
        type: 'line',
        parentHeightOffset: 0,
      ...
      markers: {
        ...
        strokeOpacity: 1,
        strokeColors: [cardColor],
        colors: ['#ac1c21', '#28c76f', '#ea5455', '#32bab5']
      },
      dataLabels: {
        enabled: false
      },
  ...
  if (typeof lineChartE2 !== undefined && lineChartE2 !== null) {
    const lineChart = new ApexCharts(lineChartE2, lineChartassetConfig);
    lineChart.render();
  }



  // linechart Depreciation

  const lineChartE3 = document.querySelector('#lineChart-depreciation'),
    lineChartdepreciationConfig = {
      chart: {
        height: 220,
        type: 'line',
        parentHeightOffset: 0,
  ...
  if (typeof lineChartE3 !== undefined && lineChartE3 !== null) {
    const lineChart = new ApexCharts(lineChartE3, lineChartdepreciationConfig);
    lineChart.render();
  }

  // Pricing chart
  const lineChartpricing = document.querySelector('#lineChart-pricing'),
    lineChartConfigpricing = {
      chart: {
        height: 220,
        type: 'line',
        parentHeightOffset: 0,
      ...
      series: [
        ...
        {
          name: "Retailer",
          data: [null, 342, 400, 457, 514, null]
        },
        {
          name: "Dealer",
  ...
  if (typeof lineChartpricing !== undefined && lineChartpricing !== null) {
    const lineChart = new ApexCharts(lineChartpricing, lineChartConfigpricing);
    lineChart.render();
  }
