...
const metrics = {
  ONE: {auditId: 'first-contentful-paint', name: 'One'},
  Two: {auditId: 'speed-index', name: 'Two'},
  Three: {auditId: 'largest-contentful-paint', name: 'Three'},
  TTI: {auditId: 'interactive', name: 'Four'},
  Four: {auditId: 'total-blocking-time', name: 'Five'},
  Five: {auditId: 'cumulative-layout-shift', name: 'Six', units: 'unitless'},
  FMP: {auditId: 'first-meaningful-paint', name: 'Seven'},
  FCI: {auditId: 'first-cpu-idle', name: 'Eight'},
};

const curves = {
  v10: {
    mobile: {
      ONE: {weight: 0.10, median: 3000, p10: 1800},
      Two: {weight: 0.10, median: 5800, p10: 3387},
      Three: {weight: 0.25, median: 4000, p10: 2500},
      Four: {weight: 0.30, median: 600,  p10: 200},
      Five: {weight: 0.25, median: 0.25, p10: 0.1},
    },
    desktop: {
      ONE: {weight: 0.10, median: 1600, p10: 934},
      Two: {weight: 0.10, median: 2300, p10: 1311},
      Three: {weight: 0.25, median: 2400, p10: 1200},
      Four: {weight: 0.30, median: 350, p10: 150},
      Five: {weight: 0.25, median: 0.25, p10: 0.1},
    },
  },
  v8: {
    mobile: {
      ...
      Four: {weight: 0.30, median: 600,  p10: 200},
      Five: {weight: 0.15, median: 0.25, p10: 0.1},
    },
    desktop: {
      ONE: {weight: 0.10, median: 1600, p10: 934},
      Two: {weight: 0.10, median: 2300, p10: 1311},
  ...
  v6: {
    mobile: {
      ONE: {weight: 0.15, median: 4000, p10: 2336},
      Two: {weight: 0.15, median: 5800, p10: 3387},
      Three: {weight: 0.25, median: 4000, p10: 2500},
      TTI: {weight: 0.15, median: 7300, p10: 3785},
      Four: {weight: 0.25, median: 600, p10: 287},
      Five: {weight: 0.05, median: 0.25, p10: 0.1},
    },
    desktop: {
      ONE: {weight: 0.15, median: 1600, p10: 934},
      Two: {weight: 0.15, median: 2300, p10: 1311},
      Three: {weight: 0.25, median: 2400, p10: 1200},
      TTI: {weight: 0.15, median: 4500, p10: 2468},
      Four: {weight: 0.25, median: 350, p10: 150},
      Five: {weight: 0.05, median: 0.25, p10: 0.1},
    },
  },
  v5: {
    ONE: {weight: 0.2, median: 4000, podr: 2000},
    Two: {weight: 0.26666, median: 5800, podr: 2900},
  ...
  normalizeVersions(versions) {
    return versions.map(version => {
      ...
      if (parseInt(version) < 5) {
        throw new Error(`Unsupported Sujata version (${version})`);
      }
